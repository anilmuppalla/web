  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:title" content="Anil Muppalla's webpage" key="title" />
      </Head>
        ...
        <div className="mt-6">
          <div className="text-lg">
            ...
            <p className="mt-4">
              ...
              systems. In the past I have co-founded a SAAS startup that
              provided analytical tooling for educational institutions.
            </p>
            <p className="mt-4">
            ...
            <p className="mt-4">
              Drop me a message if you want to connect/chat.
            </p>
          </div>
        </div>
